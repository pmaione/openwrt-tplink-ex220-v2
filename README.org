...
Replace contents of =/etc/apk/repositories.d/distfeeds.list=.

#+begin_example
  https://downloads.openwrt.org/snapshots/targets/ramips/mt7621/packages/packages.adb
  https://downloads.openwrt.org/snapshots/packages/mipsel_24kc/base/packages.adb
  https://downloads.openwrt.org/snapshots/targets/ramips/mt7621/kmods/6.6.87-1-a686872732f514412c6cabddd335e0c8/packages.adb
  ...
  https://downloads.openwrt.org/snapshots/packages/mipsel_24kc/video/packages.adb
#+end_example
